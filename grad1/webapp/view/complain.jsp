...
<script>
	function query(){
		$.ajax({
			type:"get",
			url:"/grad/bxts/getComplainList.do",
	...
	function xg(id){
		openWindow(800,500,"/grad/bxts/toAddComplainUI.do?isView=true&id="+id,'修改投诉');
	}
	
	function add(){
		openWindow(800,500,"/grad/bxts/toAddComplainUI.do?isView=false",'新增投诉');
	}
</script>